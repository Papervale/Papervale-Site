          ...
          <div class="footer-grid">
            <div class="footer-brand">
              ...
              <div class="social-links">
                ...
                <a href="https://www.linkedin.com/in/jonathan-jackson-2469156a/" target="_blank" rel="noopener noreferrer" class="social-link-li" aria-label="LinkedIn" title="Connect on LinkedIn">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="#ffffff" xmlns="http://www.w3.org/2000/svg"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.025-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.941v5.665H9.351V9h3.414v1.561h.049c.476-.9 1.637-1.852 3.369-1.852 3.602 0 4.268 2.37 4.268 5.455v6.288zM5.337 7.433c-1.144 0-2.07-.929-2.07-2.073 0-1.145.926-2.073 2.07-2.073 1.145 0 2.071.928 2.071 2.073 0 1.144-.926 2.073-2.071 2.073zM7.114 20.452H3.56V9h3.554v11.452z"/></svg>
                </a>
              </div>
            </div>
